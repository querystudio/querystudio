    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          error:
            "!border-red-500/50 !bg-red-950 [&_[data-title]]:!text-red-200",
          success:
            "!border-green-500/50 !bg-green-950 [&_[data-title]]:!text-green-200",
          warning:
            "!border-yellow-500/50 !bg-yellow-950 [&_[data-title]]:!text-yellow-200",
