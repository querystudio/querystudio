    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          ...
          <Text style={text}>
            Thanks for joining the QueryStudio waitlist. We're working hard to bring you a
            beautiful, modern database studio.
          </Text>

          <Text style={text}>
            You'll be among the first to know when we launch. We'll send you an email with early
          ...
          <Text style={footerText}>
            In the meantime, follow us for updates and sneak peeks of what's coming.
          </Text>
