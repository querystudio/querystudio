...
function SignupPage() {
  ...
  const loginGithub = () => {
    ...
    return authClient.signIn.social({ provider: 'github', callbackURL: `${window.location.origin}/dashboard` })
  }
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className='grid gap-4'>
              ...
              <div className='flex items-start gap-3'>
                <Checkbox id='terms' checked={acceptedTerms} onCheckedChange={(checked) => setAcceptedTerms(checked === true)} disabled={isLoading} className='mt-1' />
