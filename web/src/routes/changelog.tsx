...
function ChangelogPage() {
  ...
  const filteredReleases = useMemo(() => {
    ...
    return sortedReleases.filter((release) => {
      return release.version.toLowerCase().includes(query) || release.name.toLowerCase().includes(query)
    })
        ...
        <main className='container mx-auto px-4 py-12 max-w-6xl'>
          ...
          <div className='grid lg:grid-cols-[280px_1fr] gap-8'>
              ...
              <div className='space-y-6'>
                <div>
                  ...
                  <nav className='space-y-1'>
                    ...
                    {filteredReleases.length === 0 && <p className='px-3 py-2 text-sm text-muted-foreground'>No matching versions</p>}
                  </nav>
                </div>
            ...
            <div className='space-y-8'>
                ...
                <article className='space-y-6'>
                  <div className='border-b pb-6'>
                    <div className='flex items-center gap-3 mb-2'>
                      ...
                      {latestVersion === selectedRelease.version && <span className='text-xs bg-primary text-primary-foreground px-2 py-1 rounded-full'>LATEST</span>}
                    </div>
              ...
              {!selectedRelease && <div className='rounded-xl border p-6 text-sm text-muted-foreground'>No release matches your search.</div>}
            </div>
          </div>
        </main>
      </PageTransition>
