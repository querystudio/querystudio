  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "A modern, lightweight database studio built with Tauri, React, and Rust. Features AI-powered natural language queries, table browsing, and full CRUD operations.",
      },
      {
        name: "keywords",
    ...
    scripts: [
      ...
      {
        src: "https://assets-cdn.querystudio.dev/userjot-feedback.js",
        async: true,
      },
    ],
  }),
