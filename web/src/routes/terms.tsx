...
export const Route = createFileRoute('/terms')({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'QueryStudio Terms of Service - The terms and conditions for using our database management tool.',
      },
    ],
  }),
})
      ...
      <main className="container mx-auto px-4 pt-20 pb-16 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-lg text-muted-foreground mb-8">
            Welcome to QueryStudio. These Terms of Service ("Terms") govern your use of the QueryStudio desktop application and web platform at querystudio.dev (collectively, the "Service"). QueryStudio is developed and operated from Denmark.
          </p>

          <p className="text-muted-foreground mb-12">
            By using our Service, you agree to these Terms. If you disagree with any part, please do not use the Service.
          </p>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-6">1. Overview</h2>
            <p className="text-muted-foreground mb-4">QueryStudio is a database management and query tool that allows you to:</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground">You must be at least 16 years old to use QueryStudio. By creating an account, you confirm you meet this requirement.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="text-muted-foreground mb-6">
              <li><strong className="text-foreground">Monthly subscription:</strong> Billed monthly, cancel anytime</li>
              <li><strong className="text-foreground">One-time purchase:</strong> Single payment for lifetime access</li>
            </ul>
            <p className="text-muted-foreground mb-6">Prices are displayed on our website and may change with reasonable notice. Existing subscriptions will not be affected by price increases during their current billing period.</p>

            <h3 className="text-xl font-medium mb-4">3.2 Refund Policy</h3>
            <ul className="text-muted-foreground mb-6">
              <li><strong className="text-foreground">One-time purchases:</strong> 14-day refund policy from date of purchase</li>
              <li><strong className="text-foreground">Monthly subscriptions:</strong> Cancel anytime; access continues until the end of your billing period</li>
            </ul>
            <p className="text-muted-foreground">To request a refund, contact us at <a href="mailto:querystudio@lasse.email" className="text-primary hover:underline">querystudio@lasse.email</a>.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="text-muted-foreground mb-6">
              <li>Use QueryStudio to connect to databases you own or have authorization to access</li>
          ...
          <section className="mb-12">
            ...
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-6">
              ...
              <p className="text-muted-foreground mb-4">While we strive to provide reliable software:</p>
              <ul className="text-muted-foreground mb-0">
                <li>Always backup your data before making changes</li>
                <li>Review queries before execution, especially DELETE, UPDATE, or DROP statements</li>
                <li>We are not responsible for data loss caused by your actions or third-party services</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-6">QueryStudio, including its code, design, logos, and documentation, is owned by us and protected by intellectual property laws. Your license to use QueryStudio does not grant you ownership of any intellectual property.</p>
            ...
            <p className="text-muted-foreground">We grant you a limited, non-exclusive, non-transferable license to use QueryStudio in accordance with these Terms and your subscription plan.</p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-6">7. Open Source Components</h2>
            <p className="text-muted-foreground">QueryStudio may include open source software components. These components are subject to their respective open source licenses, which take precedence over these Terms for those specific components.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-6">The desktop application runs locally on your device. We strive to provide reliable software but cannot guarantee uninterrupted operation.</p>

            <h3 className="text-xl font-medium mb-4">8.2 Web Platform and Updates</h3>
            <ul className="text-muted-foreground mb-6">
              <li>The web platform (querystudio.dev) may experience occasional downtime for maintenance</li>
              <li>We may update the desktop application with new features, improvements, or bug fixes</li>
              <li>Updates are delivered automatically unless you opt out</li>
            </ul>

            <h3 className="text-xl font-medium mb-4">8.3 No Warranty</h3>
            <p className="text-muted-foreground uppercase text-sm">THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-4 uppercase text-sm">TO THE MAXIMUM EXTENT PERMITTED BY LAW, WE SHALL NOT BE LIABLE FOR:</p>
            ...
            <p className="text-muted-foreground mb-6 uppercase text-sm">OUR TOTAL LIABILITY FOR ANY CLAIMS ARISING FROM THESE TERMS OR YOUR USE OF THE SERVICE SHALL NOT EXCEED THE AMOUNT YOU PAID US IN THE 12 MONTHS PRECEDING THE CLAIM, OR €50 (WHICHEVER IS GREATER).</p>

            <h3 className="text-xl font-medium mb-4">9.3 Consumer Rights</h3>
            <p className="text-muted-foreground">Nothing in these Terms affects your statutory rights as a consumer under applicable law. Some jurisdictions do not allow the exclusion or limitation of certain damages, so some of the above limitations may not apply to you.</p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-6">10. Indemnification</h2>
            <p className="text-muted-foreground mb-4">You agree to indemnify and hold us harmless from any claims, damages, or expenses (including reasonable legal fees) arising from:</p>
            <ul className="text-muted-foreground">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-6">You may stop using QueryStudio at any time. To delete your account, contact us at <a href="mailto:querystudio@lasse.email" className="text-primary hover:underline">querystudio@lasse.email</a>.</p>

            <h3 className="text-xl font-medium mb-4">11.2 By Us</h3>
            <p className="text-muted-foreground mb-4">We may suspend or terminate your access if:</p>
            <ul className="text-muted-foreground mb-6">
            ...
            <ul className="text-muted-foreground">
              ...
              <li>Provisions that should survive termination (like limitation of liability) will continue to apply</li>
            </ul>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-6">12. Changes to These Terms</h2>
            <p className="text-muted-foreground mb-4">We may update these Terms from time to time. We will notify you of significant changes by:</p>
            <ul className="text-muted-foreground mb-6">
              <li>Posting updated Terms on our website</li>
              <li>Updating the "Last Updated" date</li>
              <li>Sending an email for material changes</li>
            </ul>
            <p className="text-muted-foreground">Continued use of the Service after changes constitutes acceptance of the new Terms.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-6">These Terms are governed by the laws of Denmark, without regard to conflict of law principles.</p>

            <h3 className="text-xl font-medium mb-4">13.2 Dispute Resolution</h3>
            <p className="text-muted-foreground mb-6">Before pursuing formal legal action, we encourage you to contact us to resolve disputes informally. If a dispute cannot be resolved informally, it shall be submitted to the courts of Denmark.</p>

            <h3 className="text-xl font-medium mb-4">13.3 EU Consumer Rights</h3>
            <p className="text-muted-foreground">If you are a consumer in the European Union, you may also have access to the European Commission's Online Dispute Resolution platform at <a href="https://ec.europa.eu/consumers/odr" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr</a>.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-6">These Terms, together with our <Link to="/privacy" className="text-primary hover:underline">Privacy Policy</Link>, constitute the entire agreement between you and QueryStudio.</p>

            <h3 className="text-xl font-medium mb-4">14.2 Severability</h3>
            <p className="text-muted-foreground mb-6">If any provision of these Terms is found to be unenforceable, the remaining provisions will continue in effect.</p>

            <h3 className="text-xl font-medium mb-4">14.3 No Waiver</h3>
            <p className="text-muted-foreground mb-6">Our failure to enforce any right or provision does not constitute a waiver of that right or provision.</p>

            <h3 className="text-xl font-medium mb-4">14.4 Assignment</h3>
            <p className="text-muted-foreground">You may not assign or transfer your rights under these Terms. We may assign our rights to a successor or affiliate.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-6">15. Contact Us</h2>
            <p className="text-muted-foreground mb-4">If you have questions about these Terms, contact us at:</p>
