    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          closeButton: 'absolute right-2 top-2 rounded-full p-1 text-muted-foreground/80 transition-colors hover:bg-muted hover:text-foreground',
          error: '!border-red-400/40 !bg-red-950/35 [&_[data-title]]:!text-red-100 [&_[data-description]]:!text-red-200/85',
          success: '!border-emerald-400/40 !bg-emerald-950/35 [&_[data-title]]:!text-emerald-100 [&_[data-description]]:!text-emerald-200/85',
          warning: '!border-amber-400/40 !bg-amber-950/35 [&_[data-title]]:!text-amber-100 [&_[data-description]]:!text-amber-200/85',
